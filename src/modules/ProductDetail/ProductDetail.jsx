...
const ProductDetail = ({ product, loading, error }) => {
  ...
  const cartQuantity = useSelector((state) =>
    selectCartItemQuantityById(state, product?.id),
  );
    ...
    <div className={styles["product-detail"]}>
      ...
      <div className={styles["product-detail__information"]}>
        ...
        <div className={styles["product-detail__prices"]}>
          ...
          {hasDiscount && (
            <>
              <div className={styles["product-detail__old-price"]}>
                ${product.price}
              </div>
              <div className={styles["product-detail__sale"]}>
                -{discountPercent}%
              </div>
            </>
          )}
        ...
        <div className={styles["product-detail__actions"]}>
          ...
          <Button fullWidth onClick={handleAddToCart} added={isAdded}>
            {isAdded ? `Added (${cartQuantity})` : "Add to cart"}
          </Button>
        </div>

        <div className={styles["product-detail__description"]}>
          <div className={styles["product-detail__description-title"]}>
            Description
          </div>
