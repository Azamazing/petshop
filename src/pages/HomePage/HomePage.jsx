...
const HomePage = () => {
  return (
    <>
      <Promo
        title="Amazing Discounts on Pets Products!"
        backgroundImage="/images/promo.webp"
        to="/all-sales"
        buttonText="Check out"
      />
      <SectionLayout
        title="Categories"
        headerNavigation={{ to: "/categories", label: "All categories" }}
      >
      ...
      <SectionLayout
        title="Sale"
        headerNavigation={{ to: "/all-sales", label: "All sales" }}
      >
